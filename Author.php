...
<ul  class=" right hide-on-med-and-down">
		  ...
		  <li><div>Hey, <?php echo $login_session; ?> </div></li>
  ...
  <ul class="collapsible popout" data-collapsible="accordion">
    <li>
      <div class="collapsible-header "><i class="material-icons">whatshot</i>view various topics</div>
    ...
    <a class="btn-floating btn-large red" href="insertp.php">
  ...
  <p>
  list of his prev abstracts </p>
  <ul class="collapsible popout" data-collapsible="accordion">
    <li>
      <div class="collapsible-header "><i class="material-icons">whatshot</i> Abstract</div>
      <div class="collapsible-body">
	  <table class="responsive-table centered striped">
        <thead>
          <tr>
              <th data-field="id">Abstract id</th>
              <th data-field="button"></th>
    ...
    <a class="btn-floating btn-large red" href="inserta.php">
      <i class="large material-icons">mode_edit</i>
    </a>
	       </td>
          </tr>
